...
export class SupplierService {
  ...
  suppliersWithConcatMap$ = of(1, 5, 8)
    ...
    //ejecuta los suscribes necesarios para la ejecucion en cascada de cada uno de los streams que
    // tengo declarados, en este caso  of transforma una lista en  observables que se emiten en secuencia
    // luego  se genera otro observable al al que estamos suscribe y unsuscribe gracias al mapConcat
  ...
  suppliersWithSwitchMap$ = of(1, 5, 8)
    ...
    // si descomento la suscriocion en el constructor de la funcion, puedo ver en la consola la opera
    //cion de los MAp
